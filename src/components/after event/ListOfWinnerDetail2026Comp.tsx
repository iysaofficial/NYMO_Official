...
const ListOfWinnerDetail2026Comp = () => {
    return(
        <>
        ...
        <section className="low-detail-after-event-section" id="low-detail-after-event">
            <div className="low-detail-after-event-heading">
                <h1 className="section-header">After Event NYMO 2026</h1>
            </div>
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            <div className="head-low-detail-document-heading">
                <h1 className="section-header">After Event Document 2026</h1>
            </div>
        </section>
            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <Link href="https://drive.google.com/file/d/1o8mfdeJpM6c_eZdxMxQJMDqwk1pI_gRL/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        <h2>Daftar Pemenang Online - SMP</h2>
                        <br />
                        <Link href="https://drive.google.com/file/d/1QDhtVUBsbrc-NSCvK9HApFSCuInUfI6K/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
...
export default ListOfWinnerDetail2026Comp
