    ...
    return(
            ...
            <div className="low-detail-after-event-container">
                <div className="low-detail-after-event-row">
                    ...
                    <div className="low-detail-after-event-video">
                        <iframe className="mt-5"  width="100%" height="415" src="https://www.youtube.com/embed/JYJtuZEc-mA?si=PJTMxZhLMtysB4Sl" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                    </div>
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            <div className="head-low-detail-document-heading">
                <h1 className="section-header">After Event Document Batch 1 2024</h1>
            </div>
        </section>
            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <Link href="https://drive.google.com/file/d/18Y-vn7OC0RSUAOtTUizh6TV1nO8NGDDl/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        <h2>Kurasi</h2>
                        <br />
                        <Link href="https://drive.google.com/drive/folders/1EHsRjxwN0ac0CCIfVwR3OAtNBuiKmOAU?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            ...
            <section className="low-press-release-section">
                <div className="low-press-release-container">
                    ...
                    <iframe src="https://drive.google.com/file/d/1pWyB0uTrG-f6MUyhwO-eDvZOj25wW0-y/preview"></iframe>
                    
                    </div>
                </div>
            </section>
            <div className="low-press-release-button-container">
                <Link href="https://drive.google.com/file/d/1pWyB0uTrG-f6MUyhwO-eDvZOj25wW0-y/view?usp=sharing" className="low-press-release-button">Download Press Release</Link>
            </div>
        </section>
        <br />
        </>
