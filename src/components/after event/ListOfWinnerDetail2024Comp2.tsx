    ...
    return(
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            <div className="head-low-detail-document-heading">
                <h1 className="section-header">After Event Document Batch 2 2024</h1>
            </div>
        </section>
            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <Link href="https://drive.google.com/file/d/12tCRuywoa1YKZFK3eHne5eyeM86aI2oB/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            <div className="head-low-detail-document-heading">
                <h1 className="section-header">Press Release Batch 2 2024</h1>
            </div>
...
export default ListOfWinnerDetail2024Comp2